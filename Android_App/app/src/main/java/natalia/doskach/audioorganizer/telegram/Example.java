...
public final class Example {
    ...
    private static String chatPosition;
    ...
    static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        ...
        switch (Example.authorizationState.getConstructor()) {
            ...
            case TdApi.AuthorizationStateWaitPhoneNumber.CONSTRUCTOR: {
                String phone = promptString("Please enter phone: ");
                Log.i("!!!","entered phone");
            ...
            case TdApi.AuthorizationStateWaitCode.CONSTRUCTOR: {
                String code = promptString("Please enter code: ");
                Log.i("!!!","entered code");
    ...
    public static void sendPhone(String phone1) throws CantLoadLibrary, InterruptedException {
        phone = phone1;
        Init.start();
    ...
    public static void main(String[] args) throws InterruptedException, CantLoadLibrary {
        ...
        while (haveAuthorization) {
            ...
            TdApi.GetChatHistory getChatHistory = new TdApi.GetChatHistory(chat_id, 0,
                    0, 20, true); // TODO: change limit if you want more messages (max 51?)
